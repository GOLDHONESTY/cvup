...
$(document).ready(function() {
            ...
            $(add_button).click(function(e) {
                ...
                if (x < max_fields) {
                    x++;
                    $(wrapper).append('<div style="margin-top:25px"><label>Institution Attended:</label><br><input type="text" name="institution[]" placeholder="e.g Petroleum Training Institute" class="institution" ><label>Qualification</label><select name="qualification[]" class="institution"><option value="" selected="selected">- Select -</option><option value="phd">Phd</option><option value="bsc">BSC</option><option value="btech">BTech</option><option value="beng">BEng</option><option value="beng">HND</option><option value="beng">OND</option><option value="beng">WAEC</option><option value="beng">NECO</option></select> <label>Year:</label><input type="month" name="instituteyear[]"><br><br><a href="javascript:void(0);" class="delete">Delete</a></div>'); //add input box
                } else {
...
$(document).ready(function() {
            ...
            $(add_button2).click(function(e) {
                ...
                if (x < max_fields2) {
                    x++;
                    $(wrapper2).append('<div style="margin-top:25px"><label>Course of Study</label><br><input type="text" name="coursestudy[]" placeholder="e.g Mechanical Engineering" class="institution2"> <label>Qualification</label><select name="qualification[]" class="institution2"><option value="" selected="selected">- Select -</option><option value="phd">Doctor of Philosophy</option><option value="bsc"> Bachelor of Science</option><option value="btech">Bachelor of Technology</option><option value="beng">Bachelor of Engineering</option><option value="beng">Higher National Diploma</option><option value="beng">Ordinary National Diploma</option><option value="beng">West African Examinations Council</option><option value="beng">National Examination Council</option></select><br><br><label>Year Complited</label><input type="month" name="yearcomploted[]"><br><br><a href="javascript:void(0);" class="delete2">Delete</a></div>'); //add input box
                } else {
                    alert('You Reached the limit')
                }
            });
